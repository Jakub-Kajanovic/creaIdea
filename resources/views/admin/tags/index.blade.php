<x-app>
    <div class="flex items-center justify-center bg-gray-50 rounded-2xl w-full h-full">
        <div class="container mx-auto p-8">
            <x-breadcrumbs :breadcrumbs="[['label' => 'Domov', 'url' => route('admin.dashboard')], ['label' => 'Tags', 'url' => route('tags.index')]]" />
            <h1 class="text-4xl font-semibold mb-10 text-center text-gray-800">Všetky tagy</h1>

            <div class="flex justify-center mb-10">
                <a href="{{ route('tags.create') }}" class="bg-black hover:bg-gray-900 text-white font-semibold py-3 px-6 rounded-full">
                    Vytvoriť nový tag
                </a>
            </div>
                        ...
                        @foreach($tags as $tag)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 border-b border-gray-200 text-right">
                                    <a href="{{ route('tags.edit', $tag->id) }}" class="text-blue-600 hover:text-blue-900 font-semibold">Upraviť</a>
