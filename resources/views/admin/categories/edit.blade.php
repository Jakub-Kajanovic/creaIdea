<x-app>
    <div class="flex items-center justify-center bg-gray-50 rounded-2xl w-full h-full">
        <div class="container mx-auto p-8">
            <x-breadcrumbs :breadcrumbs="[['label' => 'Domov', 'url' => route('admin.dashboard')], ['label' => 'Kategórie', 'url' => route('categories.index')], ['label' => 'Upraviť kategóriu']]" />
            <h1 class="text-4xl font-semibold mb-10 text-center text-gray-800">Upraviť kategóriu</h1>
            ...
            <form action="{{ route('categories.update', $category->id) }}" method="POST">
                ...
                <div class="flex justify-center">
                    <button type="submit" class="bg-black text-white py-3 px-6 rounded-full hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">Uložiť zmeny</button>
                </div>
            </form>
        </div>
    </div>
